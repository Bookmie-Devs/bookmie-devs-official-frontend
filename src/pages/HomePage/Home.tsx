...
function Home() {
  return (
    <div className="dark:bg-slate-800 bg-slate-100">
      ...
      <div className="px-20 py-8 flex flex-col space-y-12 sm:flex-row items-center sm:space-y-3">
      ...
      <div className="px-10 bg-slate-800 outline outline-yellow-400 dark:bg-slate-100">
